...
HD_PWD='C:/Users/fssal/Desktop/SPI/SPI_slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_with_single_port_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_slave_with_single_port_ram.tcl
