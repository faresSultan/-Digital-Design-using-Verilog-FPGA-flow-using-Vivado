...
HD_PWD='C:/Users/fssal/Desktop/SPI/SPI_slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_with_single_port_ram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_slave_with_single_port_ram.tcl -notrace
