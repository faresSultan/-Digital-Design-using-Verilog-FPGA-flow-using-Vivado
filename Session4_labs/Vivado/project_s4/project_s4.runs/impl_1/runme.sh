...
HD_PWD='D:/Digital IC design/-Digital-Design-using-Verilog-FPGA-flow-using-Vivado/Session4_labs/Vivado/project_s4/project_s4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_with_reg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_with_reg.tcl -notrace
