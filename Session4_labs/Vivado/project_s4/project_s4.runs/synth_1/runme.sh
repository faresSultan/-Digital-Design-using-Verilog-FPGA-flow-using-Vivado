...
HD_PWD='D:/Digital IC design/-Digital-Design-using-Verilog-FPGA-flow-using-Vivado/Session4_labs/Vivado/project_s4/project_s4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_with_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_with_reg.tcl
