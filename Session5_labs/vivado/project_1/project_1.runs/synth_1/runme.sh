...
HD_PWD='D:/Digital IC design/-Digital-Design-using-Verilog-FPGA-flow-using-Vivado/Session5_labs/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_dp_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_dp_RAM.tcl
