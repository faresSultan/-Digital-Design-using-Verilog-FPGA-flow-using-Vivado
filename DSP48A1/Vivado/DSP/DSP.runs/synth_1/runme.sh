...
HD_PWD='D:/Digital IC design/-Digital-Design-using-Verilog-FPGA-flow-using-Vivado/DSP48A1/Vivado/DSP/DSP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP48A1.tcl
