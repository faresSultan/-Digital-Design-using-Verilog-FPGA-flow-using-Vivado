...
HD_PWD='D:/Digital IC design/-Digital-Design-using-Verilog-FPGA-flow-using-Vivado/DSP48A1/Vivado/DSP/DSP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP48A1.tcl -notrace
